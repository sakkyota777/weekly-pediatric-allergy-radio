...
hosts:
  - { role: "進行役", name: "OTA",           voice: "Charon" }     # 低く落ち着いた男性（Informative）
...
- **口調（必須。台本の文章そのものに反映する）**:
  - **OTA**: 低く落ち着いた男性アナウンサー。短く、ゆっくり、丁寧。感嘆は控えめ（「なるほど」「ふむ」「それは大事ですね」）。聞き手・リスナー代弁。
  - **キュピ太郎先生**: 甲高い女性。きゃぴきゃぴ・ハイテンション。反応は大きく（「えーっ！」「すごいすごい！」「それ、超大事〜！」）、語尾は明るく弾ませる（「〜だよ〜！」「〜なの！」「ね、OTAさん！」）。
